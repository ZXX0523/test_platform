let inputNum = 1;
        ...
        function checkSku(){
            ...
            var url = '/order_V1/py/orderCheckSkuV1?env='+choose_url+'&type='+choose_type;
                ...
                if (httpRequest.readyState === 4 && httpRequest.status === 200) {
                    ...
                    for (var i=0;i<obj.data.length;i++)
                        !(function(j) {
                            ...
                            if (val.course_type === 1){var course_type = "DEMO套餐";}else if (val.course_type === 2){course_type = "正课套餐";}else if(val.course_type ===3){course_type = "赠送套餐";}else if(val.course_type ===4){course_type = "录播课套餐";} else {course_type = "其他";}
                            var td_1 = tr.insertCell(0);
        ...
        function addSku(){
            ...
            var httpRequest = new XMLHttpRequest();
            var url = '/order_V1/py/create_addSku/V1'+
                "?sku_id="+sku_id+
                "&sku_name="+sku_name+
        ...
        function submit(){
            ...
            var url = '/order_V1/py/orderImportV1Package'+
                "?nameList="+nameList+
